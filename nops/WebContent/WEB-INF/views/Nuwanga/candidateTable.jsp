...
<div class="container">
           ...
           <div class="table-title">
                <div class="row">
					...
					<div class="col-sm-6">
						<a href="registerCandidateForm" class="btn btn-success"><span>Add New Candidate</span></a>
					</div>
                </div>
            </div>
        ...
        <table class="table" id="table1">
          ...
          <tbody>
			<tr style = "background-color: #EFEFEF">
              ...
              <th>Contact No</th>
              <th>Email</th>
			  <th><form method="POST" action="NuwGetCandidateServlet">
					<input type = "text" name = "nic" value = "Enter NIC"/>
			...
			<%
				NuwCandidateService cs1 = new NuwCandidateServiceImpl();
				ArrayList<CandidateModel> al = cs1.getCandidateList();
				
				for(CandidateModel c1 : al){
			%>
            ...
            <tr>
              ...
              <td><%= c1.getNic()%></td>
              <td><%= c1.getDob() %></td>
              <td><%= c1.getCandidatePartyID() %></td>
              <td><%= c1.getElectionID()%></td>
              <td><%= c1.getAreaCode()%></td>
              <td><%= c1.getGender() %></td>
              <td><%= c1.getRace() %></td>
              <td><%= c1.getAddNo() %></td>
              <td><%= c1.getAddStreet() %></td>
              <td><%= c1.getAddCity() %></td>
              <td><%= c1.getContactNo() %></td>
              <td><%= c1.getEmail() %></td>
			  <td>
				  <form method="POST" action="NuwGetCandidateServlet">
					<input type = "hidden" name = "nic" value = "<%=c1.getNic()%>"/>
					<input type = "submit" value = "Edit/Delete" class="btn btn-success"/>
				</form>   
			  </td>
