<!DOCTYPE html>
<%@page import="com.nops.model.CastVoteModel"%>
<%@page import="java.util.ArrayList"%>
<%@page import="com.nops.service.NuwCastVoteServiceImpl"%>
<%@page import="com.nops.service.NuwCastVoteService"%>
...
<div class="container">
           ...
           <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
						<h2>Cast Vote - <b>Select Candidate</b></h2>
					</div>
          ...
          <tbody>
			<tr style = "background-color: #EFEFEF">
              ...
              <th>Select Candidate</th>
				...
				NuwCastVoteService cv1 = new NuwCastVoteServiceImpl();
				ArrayList<CastVoteModel> al = cv1.getCandidateList(request.getParameter("pid"),request.getParameter("vac")); 
				
				for(CastVoteModel c1 : al){
			%>
		  
            <tr>
              <td><%= c1.getCandidateid() %></td>
              <td><%= c1.getCandidatefname()%></td>
              <td><%= c1.getCandidatelname() %></td>
             
			  <td>
				  <form method="POST" action="NuwSaveVoteServlet"> 
					<input type = "hidden" name = "pid" value = "<%=request.getParameter("pid")%>"/>
					<input type = "hidden" name = "cid" value = "<%=c1.getCandidateid()%>"/>
					<input type = "hidden" name = "eid" value = "<%=request.getParameter("eid")%>"/>
					<input type = "hidden" name = "vid" value = "<%=request.getParameter("vid")%>"/>
					<input type = "hidden" name = "eid" value = "<%=request.getParameter("eid")%>"/>
					<input type = "hidden" name = "vac" value = "<%=request.getParameter("vac")%>"/>  
