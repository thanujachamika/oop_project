...
<div class="container">
           ...
           <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
						<h2>Cast Vote - <b>Select Political Party</b></h2>
					</div>
        ...
        <table class="table" id="table1">
          ...
          <tbody>
			<tr style = "background-color: #EFEFEF">
              ...
              <th>Political Party Abbreviation</th>
              <th>Select Political Party</th>
				...
				ArrayList<CastVoteModel> al = cv1.getPartyList();
            ...
            <tr>
              <td><%= c1.getPartyid() %></td>
              <td><%= c1.getPartyname()%></td>
              <td><%= c1.getPartyabb() %></td>
             
			  <td>
				  <form method="POST" action="NuwVoteCandidateServlet"> 
					...
					<input type = "hidden" name = "pid" value = "<%=c1.getPartyid()%>"/>
