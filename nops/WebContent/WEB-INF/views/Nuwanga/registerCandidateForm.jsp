...
<div class="containerForm">
  <form id="contact" method="POST" action="NuwAddCandidateServlet">
    <h3>Candidate</h3>
	...
	<fieldset>
		...
		<input type = "number" name = "cpid"  required>
    </fieldset>
    
	<fieldset>
    	<label> Election ID : </label>
		<input type = "number" name = "ceid"  required>
    </fieldset>
    
	<fieldset>
     	<label> Area Code : </label>
		<input type = "number" name = "careacode"   required>
    </fieldset>
    ...
    <fieldset>
     	<label> Race : </label>
		<input type = "text" name = "crace"   required>
    </fieldset>
    
	<fieldset>
     	<label> Address number : </label>
		<input type = "text" name = "caddno"   required>
    </fieldset>
    
	<fieldset>
     	<label> Address street : </label>
		<input type = "text" name = "caddstreet"   required>
    </fieldset>
    
	<fieldset>
       	<label> Address city : </label>
		<input type = "text" name = "caddcity"   required>
    </fieldset>

	<fieldset>
       	<label> Contact Number : </label>
		<input type = "number" name = "ccontactno"   required>
    </fieldset>
