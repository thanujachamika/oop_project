...
<html lang="zxx" class="no-js">
		...
		<body>	
			...
			<div class="containerForm">
			  <form id="contact" method="POST" action="ImalRegisterVoter">
			    ...
			    <fieldset>
			     	...
			     	<%if(request.getAttribute("OnameError") != null){ %>
						 	...
						 	<%} %>
					<input type = "text" name="oname" value = "${param.oname}">
			    </fieldset>
			    ...
			    <fieldset>
			      	...
			      	<%if(request.getAttribute("nicError") != null){ %>
						 	...
						 	<%} %>
					<input type = "text" name="nic" "${param.nic}">
			    </fieldset>
				...
				<fieldset>
			     	...
			     	<%if(request.getAttribute("dobError") != null){ %>
						 	...
						 	<%} %>
					<input type = "date" name="dob" "${param.dob}" >
			    </fieldset>
				...
				<fieldset>
					...
					<%if(request.getAttribute("addLine2Error") != null){ %>
						 	<div class = "error">${addLine1Error}</div>
						 	<%} %>
					<input type = "text" name="addStreet" value = "${param.addStreet}"  >
					
					<%if(request.getAttribute("addLine3Error") != null){ %>
						 	<div class = "error">${addLine1Error}</div>
						 	<%} %>
					<input type = "text" name="addCity" value = "${param.addCity}" >
				...
				<fieldset>
			     	...
			     	<%if(request.getAttribute("raceError") != null){ %>
							 	...
							 	<%} %>
					<input type = "text" name="race" value = "${param.race}">
			    </fieldset>
				...
				<fieldset>
			     	...
			     	<%if(request.getAttribute("contactNoError") != null){ %>
							 ...
							 <%} %>
					<input type = "number" name="contactNo"  value = "${param.contactNo}">
			    </fieldset>
			    ...
			    <fieldset>
			     	...
			     	<%if(request.getAttribute("areaCodeError") != null){ %>
								 ...
								 <%} %>
					<input type = "number" name="areaCode" value = "${param.areaCode}">
			    </fieldset>
			    
			    <fieldset>
				  <input type="submit" value = "Register" class = "btn"> <input type="reset" class = "btn" value = "Reset">	    
