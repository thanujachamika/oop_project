...
<html lang="zxx" class="no-js">
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        // Set chart options
        var options = {'title':'Election Results Overview',
                       'width':500,
                       'height':300
                       };
...
<div class="container">
           ...
           <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
						<h2>Election <b>Results</b></h2>
					</div>
					<div class="col-sm-6">
						<button class = "btn btn-success" onclick="myFunction()">Print/Save Results</button>
					</div>
                </div>
            </div>
        ...
        <table class="table" id="table1">
          ...
          <tbody>
			...
			<c:forEach var="result" items="${resultList}">   
				<tr>
				<td> <c:out value="${result.party}"></c:out></td>
				<td> <c:out value="${result.voteCount}"></c:out></td>
