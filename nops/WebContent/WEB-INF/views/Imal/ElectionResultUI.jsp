					...
					<div class="row">		
						<div class="col-lg-4">
							<div class="single-cat-widget">
								<div class="content relative">
								    ...
								    <a href="ImalGetElectionServlet?electionID=Presidential Election" >
								      <div class="thumb">
								  		 <img class="content-image img-fluid d-block mx-auto" src="styles/img/srilanka/download11.jpg" alt="">
								  	  </div>
								      <div class="content-details">
								        <h4 class="content-title mx-auto text-uppercase">Presidential Elections</h4>
								        <span></span>								        
								        <p>View Results</p>
								      </div>
								    </a>
						...
						<div class="col-lg-4">
							<div class="single-cat-widget">
								<div class="content relative">
									<div class="overlay overlay-bg"></div>
								    <a href="ImalGetElectionServlet?electionID=General Election">
								      <div class="thumb">
								  		 <img class="content-image img-fluid d-block mx-auto" src="styles/img/srilanka/pa.jpg" alt="">
								  	  </div>
								      <div class="content-details">
								        <h4 class="content-title mx-auto text-uppercase">Parliamentary Elections</h4>
								        <span></span>								        
								        <p>View Results</p>
								      </div>
								    </a>
						...
						<div class="col-lg-4">
							<div class="single-cat-widget">
								<div class="content relative">
									<div class="overlay overlay-bg"></div>
								    <a href="ImalGetElectionServlet?electionID=Provincial Election">
								      <div class="thumb">
								  		 <img class="content-image img-fluid d-block mx-auto" src="styles/img/srilanka/old-parliament-building-2.jpg" alt="">
								  	  </div>
								      <div class="content-details">
								        <h4 class="content-title mx-auto text-uppercase">Provincial Council Elections</h4>
								        <span></span>
								        <p>View Results</p>
								      </div>
								    </a>
						...
						<div class="col-lg-4">
							<div class="single-cat-widget">
								<div class="content relative">
									<div class="overlay overlay-bg"></div>
								    <a href="ImalGetElectionServlet?electionID=Local Authorities Election">
								      <div class="thumb">
								  		 <img class="content-image img-fluid d-block mx-auto" src="styles/img/srilanka/pa.jpg" alt="">
								  	  </div>
								      <div class="content-details">
								        <h4 class="content-title mx-auto text-uppercase">Local Authorities Elections</h4>
								        <span></span>
								        <p>View Results</p>
								      </div>
								    </a>
